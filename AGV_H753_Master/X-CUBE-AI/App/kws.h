...
/******************************************************************************/
#define AI_KWS_MODEL_NAME          "kws"
#define AI_KWS_ORIGIN_MODEL_NAME   "kws_model_tc_resnet8"

/******************************************************************************/
#define AI_KWS_ACTIVATIONS_ALIGNMENT   (4)
#define AI_KWS_INPUTS_IN_ACTIVATIONS   (4)
#define AI_KWS_OUTPUTS_IN_ACTIVATIONS  (4)
...
AI_DEPRECATED
#define AI_KWS_IN \
  ai_kws_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_IN_SIZE { \
  AI_KWS_IN_1_SIZE, \
}
#define AI_KWS_IN_SIZE_BYTES { \
  AI_KWS_IN_1_SIZE_BYTES, \
}
#define AI_KWS_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_KWS_IN_1_HEIGHT      (49)
#define AI_KWS_IN_1_CHANNEL     (40)
#define AI_KWS_IN_1_SIZE        (1960)
#define AI_KWS_IN_1_SIZE_BYTES  (7840)
...
AI_DEPRECATED
#define AI_KWS_OUT \
  ai_kws_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_KWS_OUT_SIZE { \
  AI_KWS_OUT_1_SIZE, \
}
#define AI_KWS_OUT_SIZE_BYTES { \
  AI_KWS_OUT_1_SIZE_BYTES, \
}
#define AI_KWS_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_KWS_OUT_1_CHANNEL     (10)
#define AI_KWS_OUT_1_SIZE        (10)
#define AI_KWS_OUT_1_SIZE_BYTES  (40)

/******************************************************************************/
#define AI_KWS_N_NODES (28)
 ...
 * @ref ai_kws_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_KWS_*
 * defines into file @ref kws.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
